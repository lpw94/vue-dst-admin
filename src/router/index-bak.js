...

 {
    ...
    children: [
     ...
     {path: '/components',name: 'component组件',redirect: '/components/buttons',icon:'bookmark',
      ...
      {path: '/table', name: '表格综合实例1111111111',icon:'ios-paper',component: _import('Table'),meta: { role: ['admin'] }},
...

   {
    ...
    children: [
     ...
     {path: '/home1/Demo',name: '测试',icon:'thumbsup',component: _import('Demo')},
  ...
  },
  {
    ...
    hidden:false,
    children: [
     {path: '/demo',name: '测试',icon:"social-html5",component: _import('Demo')},
     {path: '/demo2',name: '测试2222',icon:"social-html5",component: _import('Demo2')},
     {path: '/Zhonghe',name: '综合',icon:"social-html5",component: _import('yunyingjiankong/che_zonghe')},
